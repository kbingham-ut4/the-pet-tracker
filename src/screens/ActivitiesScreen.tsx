    ...
    return (
      <View style={styles.activityCard}>
        ...
        <View style={styles.activityInfo}>
          ...
          {item.duration && (
            <Text style={styles.activityDetail}>Duration: {item.duration} minutes</Text>
          )}
          {item.distance && <Text style={styles.activityDetail}>Distance: {item.distance} km</Text>}
          {item.location && <Text style={styles.activityDetail}>Location: {item.location}</Text>}
