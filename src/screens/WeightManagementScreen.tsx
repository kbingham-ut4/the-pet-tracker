...
type WeightManagementRouteProp = RouteProp<{ WeightManagement: { petId: string } }, 'WeightManagement'>;
...
export default function WeightManagementScreen() {
    ...
    const [selectedGoal, setSelectedGoal] = useState<WeightGoal>(calorieTarget?.weightGoal || WeightGoal.MAINTAIN);
        ...
        <View style={styles.card}>
            ...
            {weightTrend && (
                <View style={styles.trendContainer}>
                    <Ionicons
                        name={weightTrend.trend === 'increasing' ? 'trending-up' :
                            weightTrend.trend === 'decreasing' ? 'trending-down' : 'remove'}
                        size={20}
                        color={weightTrend.trend === 'increasing' ? COLORS.warning :
                            weightTrend.trend === 'decreasing' ? COLORS.success : COLORS.textSecondary}
                    />
                            ...
                            <View
                                style={[
                                    styles.progressFill,
                                    {
                                        ...
                                        backgroundColor: dailySummary.remainingCalories < 0 ? COLORS.warning : COLORS.primary
                                    }
                                ]}
                            />
                        </View>
