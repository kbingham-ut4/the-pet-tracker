...
export default function HealthScreen() {
    ...
    const upcomingVisits = vetVisits.filter(visit =>
        visit.nextVisitDate && visit.nextVisitDate > new Date()
    );

    const overdueVaccinations = vaccinations.filter(vacc =>
        vacc.nextDueDate && vacc.nextDueDate < new Date()
    );
            ...
            <View style={styles.healthCard}>
                ...
                <View style={styles.healthInfo}>
                    <Text style={styles.healthTitle}>
                        {pet?.name || 'Unknown Pet'} • Vet Visit
                    </Text>
        ...
        return (
            <View style={[styles.healthCard, isOverdue && styles.overdueCard]}>
                ...
                <View style={styles.healthInfo}>
                    ...
                    <Text style={styles.healthDetail}>
                        Last given: {formatDate(item.dateAdministered)}
                    </Text>
                    <Text style={styles.healthDetail}>
                        Veterinarian: Dr. {item.veterinarian}
                    </Text>
                </View>
            </View>
        );
