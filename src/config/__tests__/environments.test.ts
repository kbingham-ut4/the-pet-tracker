...
import config, { developmentConfig, testingConfig, stagingConfig, productionConfig } from '../environments';
        ...
        it('should have all required feature flags in all configs', () => {
            ...
            configs.forEach((envConfig) => {
                requiredFeatures.forEach(feature => {
                    ...
                    expect(typeof (envConfig.features as any)[feature]).toBe('boolean');
                });
            });
        });
    });
