...
describe('GraphQLSyncProvider', () => {
  ...
  let mockStorageItem: StorageItem<{ name: string; species: string }>;
  ...
  describe('initialization', () => {
    ...
    it('should throw error without endpoint', async () => {
      await expect(provider.initialize()).rejects.toThrow(
        'GraphQL endpoint is required for initialization'
      );
    });
  ...
  describe('upload operations', () => {
    ...
    describe('uploadItem', () => {
      ...
      it('should handle GraphQL errors', async () => {
        ...
        await expect(provider.uploadItem('test-key', mockStorageItem)).rejects.toThrow(
      ...
      it('should require initialization', async () => {
        ...
        await expect(uninitializedProvider.uploadItem('test-key', mockStorageItem)).rejects.toThrow(
          'GraphQLSyncProvider not initialized'
        );
      });
    ...
    describe('downloadItem', () => {
      ...
      it('should handle download errors', async () => {
        ...
        await expect(provider.downloadItem('test-key')).rejects.toThrow('Download error');
      });
    ...
    describe('deleteItem', () => {
      ...
      it('should handle delete failures', async () => {
        ...
        await expect(provider.deleteItem('test-key')).rejects.toThrow(
          'Delete failed: Invalid response'
        );
      });
      ...
      it('should handle delete errors', async () => {
        ...
        await expect(provider.deleteItem('test-key')).rejects.toThrow('Delete error');
      });
    });
  ...
  describe('error handling', () => {
    ...
    it('should require initialization before operations', async () => {
      ...
      await expect(uninitializedProvider.downloadItem('test-key')).rejects.toThrow(
        'GraphQLSyncProvider not initialized'
      );

      await expect(uninitializedProvider.deleteItem('test-key')).rejects.toThrow(
        'GraphQLSyncProvider not initialized'
      );
